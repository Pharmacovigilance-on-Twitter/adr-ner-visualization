...
#Conectar ao MongoDB
def returnDatabase(uri = 'mongodb+srv://sua conexao',
                   database = 'Your DataBase'):
    return MongoClient(uri, connectTimeoutMS=300000).get_database(database)

def returnCollection(db, collection = 'Your CRF Collection'):
...
def post_javascript_data():
    ...
    uri = "mongodb+srv://you conection"
    
    db = returnDatabase(uri = uri, database = 'Your DataBase' )
    collection = returnCollection(db, collection = 'Your CRF Collection')
